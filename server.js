...
// POST: UPSERT — ποτέ δεν διαγράφει, μόνο προσθέτει/ενημερώνει
...
// DELETE: διαγραφή συγκεκριμένου trip με ID
...
// DELETE ALL: καθαρισμός βάσης (μόνο για reset)
